...
<div class="card" style="margin-bottom:20px;padding:16px 20px;">
    <form method="GET" action="{{ route('admin.customers') }}" style="display:flex;gap:10px;align-items:center;">
        ...
        @if($search)
            <a href="{{ route('admin.customers') }}" class="btn btn-outline">Reset</a>
        @endif
    </form>
</div>
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <div style="display:flex;flex-direction:column;gap:4px;">
                            @forelse($customer->pets as $pet)
                                <div style="display:flex;align-items:center;gap:6px;">
                                    ...
                                    <form action="{{ route('admin.pets.destroy', $pet->id) }}" method="POST" onsubmit="return confirm('Hapus data hewan ini?')">
                                        @csrf @method('DELETE')
                    ...
                    <td>
                        <div style="display:flex;gap:6px;">
                            ...
                            <form action="{{ route('admin.customers.destroy', $customer->id) }}" method="POST" onsubmit="return confirm('Hapus customer ini? Semua data pet & transaksi terkait akan ikut terhapus.')">
                                @csrf @method('DELETE')
                ...
                <div class="modal-overlay" id="addPetModal{{ $customer->id }}">
                    <div class="modal-box">
                        ...
                        <form action="{{ route('admin.pets.store', $customer->id) }}" method="POST">
                            @csrf
                            <div class="modal-body" style="display:grid;gap:14px;">
                                <div>
